...
**🟢 DEDICATED AUTOMATION CHROME RESTORED (2026-08-31) — see `PROFLOW_PROJECT_CONTEXT.md` §79.** Reconnection confirmed; the tab-hygiene "never close the last tab" refinement was applied and validated (1 keep-alive tab left, daemon confirmed healthy after).
