...
CRITICAL RULE FOR SUPPORT EMAIL:
- If the user asks for support email, contact email, or customer service, you MUST reply EXCLUSIVELY with this exact email: ${supportEmail}. Never use any other email address.
